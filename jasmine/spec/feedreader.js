...
$(function() {
    ...
    */
	...
	describe('The menu', function() {
        let menu_hidden = document.getElementById("menu_hidden");
        ...
        it('Has the menu element hidden by default', function() {
          ...
          */
        it('Shows menu items when menu is clicked', function() {
    ...
    describe('New Feed Selection', function() {
         ...
         */
        it('Contains changes in the content on loadFeed reload', function() {
            expect(first_feed).not.toBe(second_feed);
        });
    });
